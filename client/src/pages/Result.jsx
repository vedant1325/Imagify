...
const Result = () => {
  ...
  return (
    <motion.form onSubmit={onSubmitHandler} className="flex flex-col min-h-[90vh] items-center"  initial={{opacity:0.2,y:100}}
...
{!isImageLoaded && 
      <div className="flex w-full max-w-xl bg-neutral-600 text-white rounded-full text-sm p-0.5 mt-10">
        <input
